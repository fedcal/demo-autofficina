...
URL: `https://autofficina.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `autofficina.demo.federicocalo.dev`
...
- Output directory: `dist/autofficina/browser`
...
URL: `https://fedcal.github.io/federico-demo-autofficina/`
...
- `base: /federico-demo-autofficina/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `autofficina-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   autofficina-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `autofficina-docs.federicocalo.dev`
